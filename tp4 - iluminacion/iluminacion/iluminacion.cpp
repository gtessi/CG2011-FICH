...
/*  lambient[]={0.3f,0.3f,0.3f,1.f}, // luz ambiente
  ldiffuse[]={0.7f,0.7f,0.7f,1.f}, // luz difusa
  lspecular[]={1.f,1.f,1.f,1.f}, // luz especular*/
  lambient[]={1.0f,0.f,0.f,1.f}, // luz ambiente
  ldiffuse[]={0.f,1.f,0.f,1.f}, // luz difusa
  lspecular[]={0.f,0.f,1.f,1.f}, // luz especular
  fondo[]={1.f,1.f,1.f,1.f},   // color de fondo
//  face_color[]={.1f,.5f,.2f,.5f}, // color de caras
  face_color[]={1.f,1.f,1.f,.5f}, // color de caras
...
//  glLightModeli(GL_LIGHT_MODEL_LOCAL_VIEWER,1);
  ...
  // material estandar
//  float fa[]={0.f,0.f,1.f,1.f},fd[]={0.f,0.f,1.f,1.f},fs[]={1.f,1.f,1.f,1.f};
  float fa[]={1.f,1.f,1.f,1.f},fd[]={1.f,1.f,1.f,1.f},fs[]={1.f,1.f,1.f,1.f};
